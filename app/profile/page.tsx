      ...
      <div className="overflow-hidden rounded-xl border">
        ...
        <div className="relative px-4 pb-3 pt-2 md:px-6">
          ...
          <div className="md:hidden relative">
            ...
            <div className="absolute -top-12 left 0 h-24 w-24 rounded-full border-4 border-white overflow-hidden bg-slate-100">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
            ...
            <div className="pl-[110px] mt-0">
              <div className="flex items-end gap-2">
                <h1 className="truncate text-[24px] leading-[1.0] font-bold">{form.display_name || 'Unnamed'}</h1>
                {profile?.role && (
            ...
            <div className="pl-[100px] mt-0.5 text-[12px] text-gray-600 whitespace-nowrap overflow-hidden text-ellipsis">
