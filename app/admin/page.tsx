...
function AdminContent() {
  ...
  const [userQ, setUserQ] = useState(''); // 👈 NEW: users search query
  ...
  // 👇 UPDATED: usersVisible filters by display_name, email, or role using userQ
  ...
  // ===== Offer actions (unchanged; RPC with direct update fallback) =====
